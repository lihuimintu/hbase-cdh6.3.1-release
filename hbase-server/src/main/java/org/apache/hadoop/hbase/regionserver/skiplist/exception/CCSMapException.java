...
public class CCSMapException extends Exception {
  ...
  public CCSMapException() {
    super();
  }

  public CCSMapException(String message) {
    super(message);
  }

  public CCSMapException(String message, Throwable cause) {
    super(message, cause);
  }

  public CCSMapException(Throwable cause) {
    super(cause);
  }
}
