 ...
 *
 * This *used* to be spark's internal logging trait, which really never should have been used by
 * hbase.  This is a copy of that internal code.
 *
 */
trait Logging {
...
private object Logging {
  ...
  try {
    ...
    val bridgeClass = Class.forName("org.slf4j.bridge.SLF4JBridgeHandler", true, classLoader)
